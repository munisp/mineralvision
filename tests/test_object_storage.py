...
import boto3  # noqa: F401 - referenced via patch('boto3.*')
import pytest
...
class TestLocalStorageClient:
    ...
    def test_put_and_get_object(self, local_client):
        ...
        obj_info = local_client.put_object("test-bucket", "test-key", test_data)  # noqa: F841 - kept for parity with source API
    ...
    def test_put_object_with_metadata(self, local_client):
        ...
        obj_info = local_client.put_object(  # noqa: F841 - kept for parity with source API
            "test-bucket",
            "test-key",
            test_data,
...
class TestS3CompatibleClient:
    ...
    def s3_client_with_mock(self):
        ...
        from api.core.object_storage import ObjectStoreConfig, S3CompatibleClient
